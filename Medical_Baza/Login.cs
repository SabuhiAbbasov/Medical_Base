        ...
        private void ClickProg_Click(object sender, EventArgs e)
        {
         ...
         //   adaptr.Fill(ds);
           ...
           // var textPass = Pass_word.Text;
            ...
            //{
                //if (Convert.ToString(ds.Tables[0].Rows[0]["Password"]) == textPass && Convert.ToString(ds.Tables[0].Rows[0]["UserName"]) == userText)
               // {
             ...
             //   {
               ...
               //     MessageBox.Show(Convert.ToString(ds.Tables[0].Rows[0]["Password"]));
               //     MessageBox.Show(Convert.ToString(ds.Tables[0].Rows[0]["UserName"]));
